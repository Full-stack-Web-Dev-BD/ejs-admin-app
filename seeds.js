...
var roledata = [{ role: "Admin" }, { role: "Aprover" }, { role: "User" }];
var userstatusdata = [{ status: "Active" }, { status: "Inactive" }];

var subjectcatdata = [{ subjectcatname: "General", subjectcatorder: 10 }];

var studycatdata = [{ studycatname: "General", studycatorder: 10 }];

var sitecatdata = [{ sitecatname: "General", sitecatorder: 10 }];

var visitcatdata = [{ visitcatname: "General", visitcatorder: 10 }];

var phasecatdata = [{ phasecatname: "General", phasecatorder: 10 }];

var studyfielddata = [
  {
    studycatname: "General",
    fieldname: "Study_short_name",
...
var subjectfielddata = [
  ...
  {
    subjectcatname: "General",
    fieldname: "Subject_DOB",
    fieldinputtype: "Date",
    fieldorder: 20,
  },
  {
    subjectcatname: "General",
    fieldname: "Subject_Address",
    fieldinputtype: "Text Box",
    fieldorder: 30,
  },
  {
    subjectcatname: "General",
    fieldname: "Subject_City",
    fieldinputtype: "Text Box",
    fieldorder: 40,
  },
  {
    subjectcatname: "General",
    fieldname: "Subject_Prov",
    fieldinputtype: "Text Box",
    fieldorder: 50,
  },
  {
    subjectcatname: "General",
    fieldname: "Subject_zip",
    fieldinputtype: "Text Box",
    fieldorder: 60,
  },
  {
    subjectcatname: "General",
    fieldname: "Subject_Country",
    fieldinputtype: "Text Box",
    fieldorder: 70,
  },
];
